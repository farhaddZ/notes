                ...
                <div class="col-lg-12">
                    <div class="box">
                        ...
                        <form action="inc/functions.php" method="post">
                            <div class="row p-4">
                                <div class="col-4"><input type="text" name="display-name"
                                        value="<?php echo $userData['display_name'] ?>" class="form-control"
                                        placeholder=""></div>
                                <div class="col-4"><input type="text" value="<?php echo $userData['title'] ?>"
                                        name="title" class="form-control" placeholder="عنوان اصلی">
                                </div>
                                <div class="col-4"><input type="text" value="<?php echo $userData['subtitle'] ?>"
                                        name="subtitle" class="form-control" placeholder="عنوان فرعی">
                                </div>
                            </div>
