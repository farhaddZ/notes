...
<?php } else { ?>
    ...
    <ul id="menu">
        <li class="menu-item"><a href="login.php"><i class="fa-solid fa-user"></i>ورود</a></li>
        <li class="menu-item"><a href="register.php"><i class="fa-solid fa-user-plus"></i>ثبت نام</a></li>
    </ul>
